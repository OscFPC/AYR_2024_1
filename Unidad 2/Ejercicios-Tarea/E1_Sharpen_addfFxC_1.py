...
for i in range(1,alto+1):
    Nuevo[0][i]=img_a_convolucinar[0][i-1]
    Nuevo[i][0]=img_a_convolucinar[i-1][0]
    Nuevo[largo+1][i]=img_a_convolucinar[largo-1][i-1]
    Nuevo[i][alto+1]=img_a_convolucinar[i-1][alto-1]
...
#PRACTICA: APLICACION DE FILTROS KERNEL PARA IMAGENES (NUESTRAS)
    #poner todos los kernels explicar como se ve y todo ese rollo en practicas